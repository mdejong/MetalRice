...
+ (InputImageRenderFrame*) renderFrameForConfig:(InputImageRenderFrameConfig)config
{
  ...
  InputImageRenderFrame *renderFrame = [[InputImageRenderFrame alloc] init];
  ...
  switch (config) {
    ...
    case TEST_32x32_DELTA_IDENT: {
      renderFrame.renderWidth  = 32;
      renderFrame.renderHeight = 32;
